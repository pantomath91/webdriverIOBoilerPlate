...
## iOS
Make sure you have a Mac, if you don't have a Mac then order one 😄, otherwise it will not work (no legal way to use iOS on Windows/Linux).
...
### iOS versions
After installation you'll get the latest supported iOS version already installed. At the moment of writing this was `iOS 12.4`. If you want an older version of iOS please download them manually by doing the following:
